...
if __name__ == "__main__":
    #scrap = UpcScrapper()
    #parser = UpcParser()
    print(get_product_data_phrase("Xiaomi Mi 10 Lite"))
    ...
    #print(sp.euro("https://www.euro.com.pl/telewizory-led-lcd-plazmowe/tcl-50ep640-tv-led-4k-android.bhtml"))
    ...
    #print(get_missing_data("Smartfon Apple iPhone 11 Pro 64 GB Dual SIM"))
